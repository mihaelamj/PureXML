public extension PureXML.XSLT {
    ...
    private static func doctype(for result: PureXML.Model.Node, _ output: Output, method: String) -> String {
        // The html output method names the doctype HTML (16.2: "The name
        // following <!DOCTYPE should be HTML or html"); the xml method uses the
        // document element name (16.1).
        let name: String? = method == "html" ? "HTML" : rootName(of: result)
