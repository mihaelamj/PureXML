extension PureXML.HTML {
    ...
    enum ForeignNames {
        ...
        /// The HTML5 "adjust SVG attributes" table: SVG attributes whose correct
        /// names are camel-cased, keyed by the lowercased form the tokenizer
        /// produces. Applied to the attributes of an element in the SVG namespace.
        static let svgAttributes: [String: String] = [
            ...
            "requiredextensions": "requiredExtensions", "requiredfeatures": "requiredFeatures", "specularconstant": "specularConstant",
