extension PureXML.HTML.Tokenizer {
    /// The HTML 4.01 named character references (the `lat1`, `special`, and
    /// `symbol` entity sets), keyed by the bare entity name. This is the stable,
    /// fully-specified set (the same coverage libxml2 ships); the much larger
    /// WHATWG superset of mostly-astral mathematical references is not included.
    /// The decoder treats the trailing semicolon as optional (lenient tag soup).
    static let namedEntities: [String: Character] = [
        ...
        // Special: markup-significant, quotes, dashes, and spacing.
        "quot": "\u{0022}", "amp": "\u{0026}", "apos": "\u{0027}", "lt": "\u{003C}", "gt": "\u{003E}",
        ...
        // Symbols: Greek letters, mathematical operators, arrows, and card suits.
