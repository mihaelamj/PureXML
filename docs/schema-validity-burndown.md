...
| **invalid-schemas-accepted** | **2461 -> 621** | we rarely catch a bad one (facet definition + applicability, default/fixed value validity, id, structural content-model, UPA determinism, complexContent + complexType content order, identity-constraint XPath-subset, and wildcard-namespace validity landed) |
