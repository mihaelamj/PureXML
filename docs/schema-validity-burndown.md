...
| **invalid-schemas-accepted** | **2461 -> 736** | we rarely catch a bad one (facet, id, structural content-model, UPA determinism, complexContent-derivation order, and identity-constraint XPath-subset validity landed) |
