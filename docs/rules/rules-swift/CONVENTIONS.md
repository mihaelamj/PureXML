...
[`core/`](rules/core/); read it first, the Swift rules build on it and do not
repeat it.

This page is the overview. The full per-area Swift rules live in
[`docs/rules/`](rules/) (index at [`docs/rules/README.md`](rules/README.md)), and
the cross-cutting rules in [`docs/rules/core/`](rules/core/).
...
The discipline lives in [`core/verification.md`](rules/core/verification.md): no
...
See [`core/commits.md`](rules/core/commits.md) and
[`core/git-discipline.md`](rules/core/git-discipline.md), and the project's
