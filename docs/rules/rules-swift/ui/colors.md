...
How a Tiledown-style native editor builds its color system: an HSV-based colors package with dynamic light/dark support and semantic naming. The colors package is independent from the theme package, which combines colors and fonts.
