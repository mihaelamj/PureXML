...
### Fixed (nineteen root causes, ~1945 deviations cleared)
...
accepted 2461 to 1190 (also: schema-document structural validity, content model and attribute values, against the schema-for-schemas); see `schema-validity-burndown.md`.
