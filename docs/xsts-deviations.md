...
on substitution-group heads · substitution-group closure stops chaining through
members whose own `block` contains `substitution` · `\w`/`\W` XSD definition · document-scoped
