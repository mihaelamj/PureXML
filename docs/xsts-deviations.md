...
### Fixed (twenty-two root causes, ~2084 deviations cleared)
...
accepted 2461 to 1051 (schema-document structural validity: content model, attribute values, name/reference + pattern-regex lexical validity, and reference resolution, against the schema-for-schemas); see `schema-validity-burndown.md`.
