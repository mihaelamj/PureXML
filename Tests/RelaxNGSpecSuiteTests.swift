...
struct RelaxNGSpecSuiteTests {
    ...
    private let knownValidRejected: Set<Int> = [
        90, 92, 93, 94, 95, 96, 98, 100, 101, 104, 108, 109, 110, 111, 115,
        119, 120, 124, 125, 126, 127, 128, 130, 131, 132, 133, 142, 190, 191,
        194, 195, 208, 209, 210, 236, 256, 258, 264, 265, 266, 268, 269, 271,
        328, 372, 374, 378, 379, 380,
    ]
    private let knownInvalidAccepted: Set<Int> = [
        101, 104, 124, 125, 126, 127, 128, 142, 264, 271,
    ]
