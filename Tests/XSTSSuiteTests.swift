...
struct XSTSSuiteTests {
    ...
    /// UPA `##other` overlap 35->31; UPA effective extension model 31->29; ref to XSD namespace is undeclared 29->27 (xsd013/xsd014); valid-rejected held at 0.
    private let knownSchemaValidRejected = 0
    private let knownSchemaInvalidAccepted = 27
